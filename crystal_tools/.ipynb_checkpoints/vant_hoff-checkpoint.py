...
def vant_hoff_plot(eq_temps, eq_consts, vh_fit_model='nonlinear'):
    """
    Inputs:
    ...
    if vh_fit_model == 'nonlinear':
        ...
        raise ValueError(f"vh_fit_model must be 'linear' or 'nonlinear', got '{vh_fit_model}'")
    
    plt.tight_layout()
    print("reg_coeffs =", reg_coeffs)
    return reg_coeffs